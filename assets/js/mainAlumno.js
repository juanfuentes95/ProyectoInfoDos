$(function(){
    ...
    $('#calendar').fullCalendar({
        ...
        events: base_url+'index.php/pincipalAlumno/getEvents',
        ...
        dayClick: function(date, event, view) {
         ...
         eventDrop: function(event, delta, revertFunc) {  
               ...
               $.post(base_url+'index.php/pincipalAlumno/dragUpdateEvent',{                            
                id:event.id,
    ...
    $('.modal').on('click', '#add-event',  function(e){
        if(validator(['title', 'description'])) {
            $.post(base_url+'index.php/pincipalAlumno/addEvent', {
                title: $('#title').val(),
    ...
    $('.modal').on('click', '#update-event',  function(e){
        if(validator(['title', 'description'])) {
            $.post(base_url+'index.php/pincipalAlumno/updateEvent', {
                id: currentEvent._id,
                title: $('#title').val(),
                description: $('#description').val(),
                color: $('#color').val(),
    ...
    $('.modal').on('click', '#delete-event',  function(e){
        $.get(base_url+'index.php/pincipalAlumno/deleteEvent?id=' + currentEvent._id, function(result){
            $('.modal').modal('hide');
            $('#calendar').fullCalendar("refetchEvents");
        });
    });
